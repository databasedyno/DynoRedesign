...
const CATALOG: CatalogItem[] = [
  ...
  { id: "creator", icon: "store", href: "/storefront?tab=page", key: "qaShortcutCreator", def: "Your page" },
  { id: "products", icon: "package", href: "/storefront?tab=products", key: "qaCatProducts", def: "Products" },
