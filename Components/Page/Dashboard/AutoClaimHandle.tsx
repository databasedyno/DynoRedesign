  ...
  return (
    ...
    >
      <DialogContent sx={{ p: { xs: 3, sm: 3.5 }, textAlign: "center" }}>
        ...
        >
          {t("autoClaim.title", { defaultValue: "Your creator page is reserved!" })}
        </Typography>
        ...
        >
          {t("autoClaim.body", { defaultValue: "It's locked to your account. Publish it to start accepting tips & payments." })}
        </Typography>
        ...
        >
          {t("autoClaim.later", { defaultValue: "Maybe later" })}
        </Button>
      </DialogContent>
    </Dialog>
  );
