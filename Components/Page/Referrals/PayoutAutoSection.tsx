...
import { PayoutOverview, PillBtn } from "./payoutShared";
...
/** Auto cash-out block: on-state, CTA, or the threshold setup form (identity check = shared step-up dialog). */
export const PayoutAutoSection: React.FC<Props> = ({ data, min, busy, pillBtn, showSetup, openSetup, autoMin, setAutoMin, onEnable, onDisable, onCancel }) => {
  ...
  return (
    <Box sx={{ mt: 2, pt: 1.75, borderTop: `1px dashed ${theme.palette.border.main}` }}>
      {data.auto ? (
        ...
        <Box data-testid="payout-auto-setup" sx={{ p: 1.5, borderRadius: "10px", border: `1px solid ${theme.palette.border.main}` }}>
          ...
          <Box sx={{ display: "flex", gap: 1, alignItems: "center", flexWrap: "wrap" }}>
            <TextField
              ...
              size="small"
              data-testid="payout-auto-min-field"
            ...
            />
            <Box component="button" type="button" data-testid="payout-auto-enable-btn" onClick={onEnable} sx={pillBtn("primary")}>
