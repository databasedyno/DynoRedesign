...
const PageTab = () => {
  ...
  return (
    <Box sx={{ width: "100%" }} data-testid="creator-page">
      ...
      {/* Stat tiles */}
      {hasHandle && (
        <Box sx={{ display: "grid", gridTemplateColumns: "repeat(3, minmax(0, 1fr))", gap: { xs: 1, sm: 1.5 }, mb: 1.25, minWidth: 0 }}>
          {statTiles.map((s) => {
            ...
            return (
              ...
              >
                <Box sx={{ display: "flex", alignItems: "center", gap: 0.75, minWidth: 0 }}>
                  <Icon icon={s.icon} width={14} color={theme.palette.text.secondary} style={{ flexShrink: 0 }} />
                  <Typography sx={{ fontFamily: "var(--font-sans)", fontSize: 10.5, fontWeight: 700, letterSpacing: "0.09em", textTransform: "uppercase", color: theme.palette.text.secondary, minWidth: 0, overflowWrap: "anywhere" }}>
                    {s.label}
                  </Typography>
                </Box>
