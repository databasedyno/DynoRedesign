...
const AudienceDoorsV3: React.FC = () => {
  ...
  const DOORS = [
    ...
    { key: "creator", featured: false, dark: false, icon: FavoriteBorderRoundedIcon, tag: t("v3.audience.creators.tag"), title: t("v3.audience.creators.title"), desc: t("v3.audience.creators.desc"), href: "/for/creators", bg: "#FFFFFF", accent: BRAND_ACCENT, accentDeep: "#4338CA", ink: "#0A0A0A", stat: t("v3.audience.creators.stat"), statLabel: t("v3.audience.creators.statLabel") },
