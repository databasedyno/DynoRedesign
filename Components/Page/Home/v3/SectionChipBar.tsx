  ...
  return (
    <Box
      ...
      sx={{
        ...
        // MOBILE PERF: no backdrop-filter below the hamburger breakpoint (same
        // iOS Safari re-rasterise stall as the header postmortem in HomeHeader/styled.tsx
        // — a fixed full-width blur layer freezes paint for seconds on @3x phones).
        backgroundColor: s.dark ? "rgba(11,11,15,0.96)" : "rgba(250,250,247,0.98)",
