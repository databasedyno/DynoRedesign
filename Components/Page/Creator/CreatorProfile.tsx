  ...
  return (
    <Box sx={{ position: 'relative', minHeight: '70vh', display: 'flex', justifyContent: 'center', px: { xs: 0, sm: 3 }, pt: { xs: '64px', sm: '88px' }, pb: { xs: '104px', sm: 4 }, overflow: 'hidden' }}>
      ...
      <Box sx={{ width: '100%', maxWidth: 620, position: 'relative', zIndex: 1 }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 0.75, mt: 2, flexWrap: 'wrap' }}>
            ...
            <Box
              ...
              sx={{
                ...
                border: `1px solid ${border}`, backgroundColor: surface, color: copied ? accent : theme.palette.text.secondary, cursor: 'pointer',
                transition: 'border-color 0.2s ease, color 0.2s ease', '&:hover': { borderColor: accent, color: accent },
              }}
            >
          ...
          >
            ...
            <Button
              ...
              sx={supportWidget?.enabled
                // C6/C8: one gradient primary per page — when the tip widget is the
        ...
        {/* ── Share sheet — C5: after the content worth sharing, not before it ── */}
        <Box data-testid='creator-share' sx={{ mt: 5, mb: 1 }}>
        ...
        <MerchantTrustRow handle={creator.handle} sx={{ mt: 3 }} />
