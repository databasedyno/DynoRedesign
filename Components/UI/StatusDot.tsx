...
const TONES: Record<StatusTone, ToneSpec> = {
  ...
  awaiting: { dot: "#F59E0B", light: "#B45309", dark: "#FBBF24", hollow: true }, // hollow amber
};

/** Theme-aware colours for a tone — for surfaces that echo the chip (icon tints, bars). */
export const statusToneColors = (tone: StatusTone, isDark: boolean) => {
  const t = TONES[tone] ?? TONES.neutral;
  return { fg: isDark ? t.dark : t.light, dot: t.dot, hollow: !!t.hollow };
};
