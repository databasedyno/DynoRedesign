        ...
        {mode === "totp" ? (
          ...
          <>
            ...
            <Button
              ...
              sx={{ mt: 2, fontWeight: 600, fontSize: "14px", color: "#FFFFFF", backgroundColor: "#4F46E5", py: "10px", borderRadius: "8px", textTransform: "none", "&:hover": { backgroundColor: "#4338CA" }, "&:disabled": { backgroundColor: "#A5B4FC", color: "#FFF" } }}
            >
              {loading ? <CircularProgress size={20} sx={{ color: "#FFF" }} /> : t("twoFactor.verifyBackup", { defaultValue: "Verify backup code" })}
            </Button>
          </>
        )}
      </DialogContent>
