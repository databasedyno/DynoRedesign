...
const CryptoItemCard: React.FC<CryptoItemCardProps> = React.memo(
  ({
    ...
    // The friendly name and the network label are shown side by side. For coins
    // where they are identical (e.g. XRP, POLYGON, RLUSD) this rendered the same
    // text twice, so only show the label pill when it actually adds information.
    const showLabelPill =
