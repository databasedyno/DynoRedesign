      ...
      {includeTax && setTaxInclusive ? (
        ...
        >
          <Box sx={{ display: "flex", flexDirection: "column", gap: "2px" }}>
            <Text sx={{ fontSize: "13px", color: theme.palette.text.primary }}>
              {tPaymentLink("pricesIncludeTax", { defaultValue: "Prices include tax" })}
            </Text>
            <Text sx={{ fontSize: "11px", color: theme.palette.text.secondary }}>
              {tPaymentLink("pricesIncludeTaxHint", { defaultValue: "Back out VAT from the price instead of adding on top" })}
            </Text>
          </Box>
          <Box sx={{ display: "flex", gap: "12px", alignItems: "center" }}>
            <CustomSwitch
