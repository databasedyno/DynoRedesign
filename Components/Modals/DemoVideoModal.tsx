...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    detail: 'They open the link. Choose USDT-TRC20, USDC-Polygon, BTC — 13 chains supported. Confirm and pay from their wallet.',
    color: '#7C3AED',
    accent: '#A78BFA',
  },
  {
    ...
    detail: 'Funds land in your DynoPay wallet in stablecoin. Withdraw to bank, spend, or hold. 0.5% flat. No chargebacks, ever.',
    color: '#10B981',
    accent: '#34D399',
  },
];
