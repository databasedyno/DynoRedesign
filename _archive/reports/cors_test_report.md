...
## Backend URL: https://speedup-check.preview.emergentagent.com
...
| 5 | https://speedup-check.preview.emergentagent.com | ALLOWED | `*` (wildcard) | ⚠️ ALLOWED (wrong reason) |
...
### Test CORS Preflight
```bash
curl -v -X OPTIONS "https://speedup-check.preview.emergentagent.com/api/csrf-token" \
...
```bash
curl -v -X GET "https://speedup-check.preview.emergentagent.com/api/csrf-token" \
  -H "Origin: https://dynopay.com"
```
