...
## Backend URL: https://passphrase-init.preview.emergentagent.com
...
| 5 | https://passphrase-init.preview.emergentagent.com | ALLOWED | `*` (wildcard) | ⚠️ ALLOWED (wrong reason) |
...
### Test CORS Preflight
```bash
curl -v -X OPTIONS "https://passphrase-init.preview.emergentagent.com/api/csrf-token" \
...
```bash
curl -v -X GET "https://passphrase-init.preview.emergentagent.com/api/csrf-token" \
  -H "Origin: https://dynopay.com"
```
