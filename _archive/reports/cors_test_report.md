...
## Backend URL: https://onboard-app-11.preview.emergentagent.com
...
| 5 | https://onboard-app-11.preview.emergentagent.com | ALLOWED | `*` (wildcard) | ⚠️ ALLOWED (wrong reason) |
...
### Test CORS Preflight
```bash
curl -v -X OPTIONS "https://onboard-app-11.preview.emergentagent.com/api/csrf-token" \
...
```bash
curl -v -X GET "https://onboard-app-11.preview.emergentagent.com/api/csrf-token" \
  -H "Origin: https://dynopay.com"
```
