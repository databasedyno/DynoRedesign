...
## Backend URL: https://user-profile-split.preview.emergentagent.com
...
| 5 | https://user-profile-split.preview.emergentagent.com | ALLOWED | `*` (wildcard) | ⚠️ ALLOWED (wrong reason) |
...
### Test CORS Preflight
```bash
curl -v -X OPTIONS "https://user-profile-split.preview.emergentagent.com/api/csrf-token" \
...
```bash
curl -v -X GET "https://user-profile-split.preview.emergentagent.com/api/csrf-token" \
  -H "Origin: https://dynopay.com"
```
