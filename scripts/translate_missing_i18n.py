...
def openai_translate(mapping, lang_name):
    sys_prompt = (
        ...
        "Rules: translate naturally and concisely for UI; keys ending in _one are singular and _other plural (count may be 0 or >1); DO NOT translate or alter "
        "interpolation placeholders like {{name}} {{count}} {{amount}} {amount}, HTML-like tags such as <b></b> <addr></addr>, HTML tags like "
