...
## Backend URL: https://dynopay-preview-9.preview.emergentagent.com
...
| 5 | https://dynopay-preview-9.preview.emergentagent.com | ALLOWED | `*` (wildcard) | ⚠️ ALLOWED (wrong reason) |
...
### Test CORS Preflight
```bash
curl -v -X OPTIONS "https://dynopay-preview-9.preview.emergentagent.com/api/csrf-token" \
...
```bash
curl -v -X GET "https://dynopay-preview-9.preview.emergentagent.com/api/csrf-token" \
  -H "Origin: https://dynopay.com"
```
