...
## Backend URL: https://checkout-preview-25.preview.emergentagent.com
...
| 5 | https://checkout-preview-25.preview.emergentagent.com | ALLOWED | `*` (wildcard) | ⚠️ ALLOWED (wrong reason) |
...
### Test CORS Preflight
```bash
curl -v -X OPTIONS "https://checkout-preview-25.preview.emergentagent.com/api/csrf-token" \
...
```bash
curl -v -X GET "https://checkout-preview-25.preview.emergentagent.com/api/csrf-token" \
  -H "Origin: https://dynopay.com"
```
