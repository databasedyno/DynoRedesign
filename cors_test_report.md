...
## Backend URL: https://rapid-launch-hub.preview.emergentagent.com
...
| 5 | https://rapid-launch-hub.preview.emergentagent.com | ALLOWED | `*` (wildcard) | ⚠️ ALLOWED (wrong reason) |
...
### Test CORS Preflight
```bash
curl -v -X OPTIONS "https://rapid-launch-hub.preview.emergentagent.com/api/csrf-token" \
...
```bash
curl -v -X GET "https://rapid-launch-hub.preview.emergentagent.com/api/csrf-token" \
  -H "Origin: https://dynopay.com"
```
