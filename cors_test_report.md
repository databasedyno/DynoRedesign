...
## Backend URL: https://payment-gateway-673.preview.emergentagent.com
...
| 5 | https://payment-gateway-673.preview.emergentagent.com | ALLOWED | `*` (wildcard) | ⚠️ ALLOWED (wrong reason) |
...
### Test CORS Preflight
```bash
curl -v -X OPTIONS "https://payment-gateway-673.preview.emergentagent.com/api/csrf-token" \
...
```bash
curl -v -X GET "https://payment-gateway-673.preview.emergentagent.com/api/csrf-token" \
  -H "Origin: https://dynopay.com"
```
