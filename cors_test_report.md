...
## Backend URL: https://merchant-checkout-22.preview.emergentagent.com
...
| 5 | https://merchant-checkout-22.preview.emergentagent.com | ALLOWED | `*` (wildcard) | ⚠️ ALLOWED (wrong reason) |
...
### Test CORS Preflight
```bash
curl -v -X OPTIONS "https://merchant-checkout-22.preview.emergentagent.com/api/csrf-token" \
...
```bash
curl -v -X GET "https://merchant-checkout-22.preview.emergentagent.com/api/csrf-token" \
  -H "Origin: https://dynopay.com"
```
