...
## Backend URL: https://credentials-preview.preview.emergentagent.com
...
| 5 | https://credentials-preview.preview.emergentagent.com | ALLOWED | `*` (wildcard) | ⚠️ ALLOWED (wrong reason) |
...
### Test CORS Preflight
```bash
curl -v -X OPTIONS "https://credentials-preview.preview.emergentagent.com/api/csrf-token" \
...
```bash
curl -v -X GET "https://credentials-preview.preview.emergentagent.com/api/csrf-token" \
  -H "Origin: https://dynopay.com"
```
