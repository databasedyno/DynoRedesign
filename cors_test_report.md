...
## Backend URL: https://beow-preview-build.preview.emergentagent.com
...
| 5 | https://beow-preview-build.preview.emergentagent.com | ALLOWED | `*` (wildcard) | ⚠️ ALLOWED (wrong reason) |
...
### Test CORS Preflight
```bash
curl -v -X OPTIONS "https://beow-preview-build.preview.emergentagent.com/api/csrf-token" \
...
```bash
curl -v -X GET "https://beow-preview-build.preview.emergentagent.com/api/csrf-token" \
  -H "Origin: https://dynopay.com"
```
