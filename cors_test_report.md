...
## Backend URL: https://blockchain-bridge-3.preview.emergentagent.com
...
| 5 | https://blockchain-bridge-3.preview.emergentagent.com | ALLOWED | `*` (wildcard) | ⚠️ ALLOWED (wrong reason) |
...
### Test CORS Preflight
```bash
curl -v -X OPTIONS "https://blockchain-bridge-3.preview.emergentagent.com/api/csrf-token" \
...
```bash
curl -v -X GET "https://blockchain-bridge-3.preview.emergentagent.com/api/csrf-token" \
  -H "Origin: https://dynopay.com"
```
