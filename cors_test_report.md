...
## Backend URL: https://checkout-deployment-1.preview.emergentagent.com
...
| 5 | https://checkout-deployment-1.preview.emergentagent.com | ALLOWED | `*` (wildcard) | ⚠️ ALLOWED (wrong reason) |
...
### Test CORS Preflight
```bash
curl -v -X OPTIONS "https://checkout-deployment-1.preview.emergentagent.com/api/csrf-token" \
...
```bash
curl -v -X GET "https://checkout-deployment-1.preview.emergentagent.com/api/csrf-token" \
  -H "Origin: https://dynopay.com"
```
