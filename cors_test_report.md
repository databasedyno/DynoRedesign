...
### Test CORS Preflight
```bash
curl -v -X OPTIONS "https://blockchain-processor.preview.emergentagent.com/api/csrf-token" \
...
```bash
curl -v -X GET "https://blockchain-processor.preview.emergentagent.com/api/csrf-token" \
  -H "Origin: https://dynopay.com"
```
