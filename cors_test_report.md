...
## Backend URL: https://multi-chain-checkout-6.preview.emergentagent.com
...
| 5 | https://multi-chain-checkout-6.preview.emergentagent.com | ALLOWED | `*` (wildcard) | ⚠️ ALLOWED (wrong reason) |
...
### Test CORS Preflight
```bash
curl -v -X OPTIONS "https://multi-chain-checkout-6.preview.emergentagent.com/api/csrf-token" \
...
```bash
curl -v -X GET "https://multi-chain-checkout-6.preview.emergentagent.com/api/csrf-token" \
  -H "Origin: https://dynopay.com"
```
