...
## Backend URL: https://settle-engine.preview.emergentagent.com
...
| 5 | https://settle-engine.preview.emergentagent.com | ALLOWED | `*` (wildcard) | ⚠️ ALLOWED (wrong reason) |
...
### Test CORS Preflight
```bash
curl -v -X OPTIONS "https://settle-engine.preview.emergentagent.com/api/csrf-token" \
...
```bash
curl -v -X GET "https://settle-engine.preview.emergentagent.com/api/csrf-token" \
  -H "Origin: https://dynopay.com"
```
