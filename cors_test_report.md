...
## Backend URL: https://scoped-shop.preview.emergentagent.com
...
| 5 | https://scoped-shop.preview.emergentagent.com | ALLOWED | `*` (wildcard) | ⚠️ ALLOWED (wrong reason) |
...
### Test CORS Preflight
```bash
curl -v -X OPTIONS "https://scoped-shop.preview.emergentagent.com/api/csrf-token" \
...
```bash
curl -v -X GET "https://scoped-shop.preview.emergentagent.com/api/csrf-token" \
  -H "Origin: https://dynopay.com"
```
