 ...
 */
export const toPublicReceipt = (token: string, snap: ReceiptSnapshot) => {
  ...
  const feeNote = snap.breakdown
    ? t(snap.breakdown.feePayer === "customer" ? "labels.feePaidByCustomer" : "labels.feePaidByMerchant", L)
    : "";
  return {
    token,
    lang: L,
    ...
    breakdown: snap.breakdown
      ? { merchantReceives: snap.breakdown.merchantReceives, platformFee: snap.breakdown.platformFee, feePayer: snap.breakdown.feePayer, feeNote }
      : null,
    labels: {
      ...
      breakdown: t("receipt.breakdown", L),
      youPaid: t("receipt.youPaid", L),
      merchantReceives: t("labels.merchantReceives", L),
      platformFee: t("labels.platformFee", L),
