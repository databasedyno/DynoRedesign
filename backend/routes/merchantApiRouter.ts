...
// ============================================================
router.post("/createUser", apiKeyOnlyMiddleware, asyncHandler(async (req, res) => {
...
// ============================================================
router.post("/cryptoPayment", legacyApiAuthMiddleware, asyncHandler(async (req, res) => {
  ...
  try {
    ...
    return sendError(res, { status: 500, message: "Failed to get currency rates" });
  }

  if (!cryptoRates || cryptoRates.length === 0 || !cryptoRates[0]?.amount) {
    return sendError(res, { status: 500, message: "Failed to get currency conversion rate" });
  }
...
// ============================================================
router.post("/createPayment", legacyApiAuthMiddleware, asyncHandler(async (req, res) => {
  const userData = res.locals.user;
  const data = res.locals.apiKeyData;
...
// ============================================================
router.post("/embed/session", legacyApiAuthMiddleware, asyncHandler(async (req, res) => {
  const userData = res.locals.user;
  const data = res.locals.apiKeyData;
...
// ============================================================
router.post("/addFunds", legacyApiAuthMiddleware, asyncHandler(async (req, res) => {
  const userData = res.locals.user;
  const data = res.locals.apiKeyData;
...
// ============================================================
router.post("/useWallet", legacyApiAuthMiddleware, asyncHandler(async (req, res) => {
  const userData = res.locals.user;
  const data = res.locals.apiKeyData;
