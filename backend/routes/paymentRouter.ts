...
// Rich social share card (rendered PNG: cover + goal bar + % funded) for
// donation campaigns. Public, read-only, cached. Used by /pay OG tags and the
// public donation demo page.
paymentRouter.get("/og-image", paymentRateLimiter, paymentController.getCampaignOgImage);
...
paymentRouter.post("/creator/:handle/visit", paymentRateLimiter, paymentController.trackCreatorVisit);
