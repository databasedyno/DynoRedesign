...
- Re-provisioned per documented procedure on fresh container; preview URL now https://7cf0a9cc-76f7-4dc9-9220-24f400ee928a.preview.emergentagent.com; safety overrides re-applied (NODE_ENV=production, WORKER_ROLE=secondary, ENABLE_BACKGROUND_JOBS=false); next build standalone; all health checks green.
