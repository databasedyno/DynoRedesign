...
const SUCCESS_INK = '#027A48' // AA text tone of SUCCESS on white
        ...
        <Box sx={{ maxWidth: 560, mx: 'auto' }}>
          ...
          <Box className="receipt-card" sx={{ border: `1px solid ${border}`, borderRadius: '16px', bgcolor: theme.palette.background.paper, overflow: 'hidden' }}>
            ...
            <Box sx={{ px: { xs: 2.5, sm: 3.5 }, pt: 2.5, pb: 3, borderBottom: `1px solid ${border}` }}>
              <Typography component="h1" sx={{ fontSize: 11, fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase', color: muted }}>{L.amountPaid}</Typography>
              <Typography
                  ...
                  <Box sx={{ minWidth: 0 }}>
                    ...
                    {receipt.merchant.verified && (
                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5, mt: 0.25 }} data-testid="public-receipt-verified">
                        <Icon icon="mdi:check-decagram" width={14} color={SUCCESS_INK} />
                        <Typography sx={{ fontSize: 12, color: SUCCESS_INK, fontWeight: 600 }}>{L.verifiedMerchant}</Typography>
                      </Box>
                    )}
                  </Box>
                </Box>
          ...
          <Box sx={{ mt: 2.5, textAlign: 'center' }}>
            ...
            <Typography sx={{ fontSize: 12, color: muted, mt: 1.5 }}>
              {L.tagline} ·{' '}
              <Box component="a" href="https://dynopay.com" target="_blank" rel="noopener noreferrer" sx={{ color: brandFg(isDark), textDecoration: 'underline', textUnderlineOffset: 2 }}>
                dynopay.com
              </Box>{' '}
              ·{' '}
              <Box component="a" href="https://dynopay.com/help-support" target="_blank" rel="noopener noreferrer" sx={{ color: brandFg(isDark), textDecoration: 'underline', textUnderlineOffset: 2 }}>
                {L.support}
              </Box>
            </Typography>
            <Typography sx={{ fontSize: 11.5, color: muted, mt: 0.5 }}>{L.rights} · {L.autoGenerated}</Typography>
          </Box>
        </Box>
      </Box>
    </>
