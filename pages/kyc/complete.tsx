...
const KycCompletePage: React.FC = () => {
  ...
  return (
    <>
      <Head>
        <title>{t("kycComplete.title", { defaultValue: "Verification submitted" })} — Dynopay</title>
        ...
        <Container maxWidth="sm">
          <Stack spacing={3} alignItems="center" textAlign="center">
            ...
            <Typography variant="h4" sx={{ fontWeight: 700 }}>
              {t("kycComplete.title", { defaultValue: "Verification submitted" })}
            </Typography>

            <Typography variant="body1" color="text.secondary">
              {t("kycComplete.body", { defaultValue: "Thanks — your details were received and are being reviewed. This usually takes just a few minutes. We'll email you and add an in-app notification the moment your verification is complete, so there's nothing else you need to do here." })}
            </Typography>
            ...
            >
              {t("kycComplete.backToDashboard", { defaultValue: "Back to dashboard" })}
            </Button>

            <Typography variant="caption" color="text.secondary">
              {t("kycComplete.closeTab", { defaultValue: "You can safely close this tab." })}
            </Typography>
          </Stack>
        </Container>
      </Box>
