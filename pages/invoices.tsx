...
const InvoicesPage = ({ setPageName, setPageDescription }: pageProps) => {
  ...
  const openInvoicePreview = (inv: Invoice) => {
    setPreviewInvoice({
      ...
      total_label: formatUsdInDisplay(inv.total_usd),
    });
  };
                  ...
                  {invoiceLoading ? (
                    ...
                    invoices.map((inv) => (
                      <Box
                        ...
                        {...rowKeyProps(() => openInvoicePreview(inv), inv.invoice_number)}
                        onFocus={() => prefetchInvoicePdf(inv.invoice_id)}
              ...
              <Box sx={{ display: "flex", gap: 1.5, flexWrap: "wrap" }}>
                ...
                <FormControl size="small">
                  <Select
                    ...
                    inputProps={{ "aria-label": t("invoices.groupBy") }}
                    sx={{
                      fontFamily: "var(--font-sans)",
                      fontSize: 13,
                      minWidth: 120,
