...
# Configuration
BASE_URL = "https://cf119f74-56da-4ff0-a552-7a9fff55efda.preview.emergentagent.com/api"
...
def test_9_upload_campaign_image(token: str):
    ...
    full_url = url if url.startswith("http") else f"https://cf119f74-56da-4ff0-a552-7a9fff55efda.preview.emergentagent.com{url}"
