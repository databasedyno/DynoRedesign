...
/** Storage keys + grace window, exported for the pre-paint redirect script on the landing page. */
export const AUTH_PERSISTENCE = { PERSIST_KEY, HEARTBEAT_KEY, GRACE_MS } as const;
