 ...
 * (NEXT_PUBLIC_CREATOR_BASE_URL, e.g. https://dynopay.me) so the "access URL"
...
/** Full public URL for a creator handle, e.g. "https://dynopay.me/alice". */
...
/** Scheme-less display form, e.g. "dynopay.me/alice". */
export const prettyCreatorUrl = (handle?: string | null): string =>
  buildCreatorUrl(handle).replace(/^https?:\/\//, "");

/** Scheme-less base domain for display, e.g. "dynopay.me". */
